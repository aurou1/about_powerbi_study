...
> 设计意图：各品类目标毛利率不同——数码≈12% < 家居≈35% / 食品≈30% < 服饰≈45% < 美妆≈55%。`list_price = cost_price / (1 - margin)`，用于练「品类毛利差异」。明细表的 `unit_price / unit_cost` 直接取自这里。
...
| `category`（品类） | 家居 / 数码 / 服饰 / 食品 / 美妆 | 毛利率 数码≈12% < 食品≈30% ≈ 家居≈35% < 服饰≈45% < 美妆≈55% |
